...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        ...
        Uses setters to validate values
        """
        self.width = width
        self.height = height
    ...
    def width(self, value):
        """Setter for the width attribute with type and value validation"""
    ...
    def height(self, value):
        """Setter for the height attribute with type and value validation"""
        if not isinstance(value, int):
